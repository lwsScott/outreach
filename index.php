...
$f3 = Base::instance();
$f3->set('ethnicities', array('caucasian', 'african', 'african american', 'latinX', 'native american', 'asian', 'pacific islander', 'eskimo','mixed','other', 'prefer not to share' ));
$f3->set('listResources', array('thrift shop','gas','water','energy bill','food','dol','rent','other'));
$f3->set('listGenders', array('male','female','other','prefer not to share'));
...
//    $database = new Database();
//    $password = '<set new password here>';
//    echo $password;
